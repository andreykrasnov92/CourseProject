...
import facades.DisciplinesFacade;
...
@ManagedBean(name = "disciplinesController")
@SessionScoped
public class DisciplinesController implements Serializable {
    ...
    @EJB
    private DisciplinesFacade ejbFacade;
    ...
    public String create() {
        try {
            current.setDisciplineId(-1);
            getFacade().create(current);
            JsfUtil.addSuccessMessage("Дисциплина была успешно добавлена");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Дисциплина была успешно отредактирована");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Дисциплина была успешно удалена");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class DisciplinesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Disciplines) {
                ...
                return getStringKey(o.getDisciplineId());
            } else {
