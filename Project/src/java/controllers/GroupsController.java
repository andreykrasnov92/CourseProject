...
public class GroupsController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("Группа была успешно добавлена");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Группа была успешно отредактирована");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Группа была успешно удалена");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
