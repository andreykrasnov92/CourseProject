...
public class TeachersController implements Serializable {
    ...
    @EJB
    private TeachersFacade ejbFacade;
    ...
    public String create() {
        try {
            current.setTeacherId(-1);
            getFacade().create(current);
            JsfUtil.addSuccessMessage("Преподаватель был успешно добавлен");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Преподаватель был успешно отредактирован");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Преподаватель был успешно удалён");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
