...
public class StudentsController implements Serializable {
    ...
    @EJB
    private StudentsFacade ejbFacade;
    ...
    public String create() {
        try {
            current.setStudentId(-1);
            getFacade().create(current);
            JsfUtil.addSuccessMessage("Студент был успешно добавлен");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Студент был успешно отредактирован");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Студент был успешно удалён");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
